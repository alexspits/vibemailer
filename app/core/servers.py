...
class ServerConfig(BaseModel):
    ...
    # Хвосты, которыми на этой панели помечали клиентов: `chain`, `vpn`, название
    # локации. При автоподборе клиента под получателя они игнорируются — о человеке
    # они ничего не говорят, а похожесть имён занижают. Ключ самого сервера добавлять
    # не нужно, он учитывается всегда.
